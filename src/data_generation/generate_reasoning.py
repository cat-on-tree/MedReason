...
"""
    ...
    reformat_question, question_entities = reformat_result["description"]["text"], reformat_result["description"][
        "entities"]
    ...
    if args.batch_size == 1:
        with open(result_file_name, 'w') as f:
            for ids in tqdm(range(args.start_idx, args.start_idx + test_samples)):
                ...
                data_list = {"id": ids, "question": question, "reasoning": reason, "huatuo": comparing_reasoning,
